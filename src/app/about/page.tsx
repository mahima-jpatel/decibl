      ...
      <div className="flex-1 flex flex-col items-left px-4 md:px-8 py-12 relative">
        ...
        <div className="max-w-4xl mx-auto text-left space-y-10 relative z-10 py-8" style={{paddingLeft: '300px', paddingRight: '300px'}}>
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-50 to-indigo-50 p-8 rounded-2xl">
            ...
            <p className="text-2xl font-bold text-purple-700 mb-6" style={{margin: '10px', fontWeight: 'bold'}}>
              Start today—Build emotional resilience, one step at a time, with Decibl.
            </p>
            
            <Link href="/signup">
              <button className="cta-button text-white bg-orange-500 py-3 px-10 rounded-lg text-xl hover:bg-orange-600 transition-colors shadow-md">
                Join the Waitlist
              </button>
            </Link>
            <p></p>
